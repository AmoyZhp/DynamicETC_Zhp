...
class StaticGraph():
    ...
    def _init_graph(self, node_dict_list, edge_dict_list):
        ...
        for node_dict in node_dict_list:
            ...
            self.nodes_adjacency_list.append(AdjacencyNode(node))
    ...
    def _add_edge_to_adjacency_list(self, source, target):
        ...
        node = AdjacencyNode(Node(end_node.node_id, end_node.label))
    ...
    def data(self):
        ...
        for node in self.nodes_list:
            nodes_data.append(node.__dict__)
        for edge in self.edges_list:
            edges_data.append(edge.__dict__)
        return {
            'nodes': nodes_data,
            'edges': edges_data
        }
